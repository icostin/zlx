 ...
 */
ZLX_INLINE zlx_np_t * zlx_dlist_init (zlx_np_t * ZLX_RESTRICT list_p)
{
 ...
 */
ZLX_INLINE int zlx_dlist_is_empty (zlx_np_t * ZLX_RESTRICT list_p)
{
 ...
 *
 */
ZLX_INLINE void zlx_dlist_insert
(
    zlx_np_t * anchor_p,
    zlx_np_t * to_ins_p,
    int dir
 ...
 *      element to unlink
 */
ZLX_INLINE void zlx_dlist_delete
(
    zlx_np_t * to_del_p
)
{
...
#define ZLX_DLIST_APPEND(_list, _obj_p, _np_field) \
    (zlx_dlist_insert(&(_list), &(_obj_p)->_np_field, ZLX_PREV))
...
#define ZLX_DLIST_PREPEND(_list, _obj_p, _np_field) \
    (zlx_dlist_insert(&(_list), &(_obj_p)->_np_field, ZLX_NEXT))
